...
# paths
path_fig  = 'C:\\Users\\polar\\OneDrive - The University of Kansas\\PHSX 616\\GitHub\PHSX616\\Lab4 - Photoelectric Effect\\Figures\\'
path_data = 'C:\\Users\\polar\\OneDrive - The University of Kansas\\PHSX 616\\GitHub\PHSX616\\Lab4 - Photoelectric Effect\\Data\\'
...
def UnpackTable(fname: str) -> dict[str,np.array] :
    ...
    arr = np.genfromtxt(fname, delimiter=",", dtype=str, encoding='utf-8-sig')
